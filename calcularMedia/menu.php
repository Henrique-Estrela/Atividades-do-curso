  <div class="wrapper flex_box">
    <form method="post" action="salvar.php">
        ...
        <label for="Português" class="text-center"><h4>Português</h4></label>
        <div class="flex-container">
            <div class="input">
                <label>
                Quarta nota:
                </label>
                <input class="name" placeholder="Digita a nota" type="number" name="nota4">
            </div>
            ...
            <div class="input">
                ...
                <input placeholder="Digite o peso" class="name" type="number" name="peso4">
            </div>
        </div>

        <label for="Ciências" class="text-center"><h4>Ciências</h4></label>
         <div class="flex-container">
            <div class="input">
                <label>
                Quinta nota:
                </label>
                <input class="name" placeholder="Digita a nota" type="number" name="nota5">
            </div>
            ...
            <div class="input">
                ...
                <input placeholder="Digite o peso" class="name" type="number" name="peso5">
            </div>
        </div>
